...
function addToCart(article) {
 ...
 Pour consulter votre panier, cliquez sur OK`)) {
            ...
            if (quantityPicked.value <= 0 && colorPicked.value != "") {
                ...
                const warning = document.querySelector(".item__content__settings__quantity").insertAdjacentHTML("afterbegin", `<style>
            ...
            if (colorPicked.value == "" && quantityPicked.value != 0) {
                const warning = document.querySelector(".item__content__settings__color").insertAdjacentHTML("afterbegin", `<style>
